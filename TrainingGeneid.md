...
#### 4) "-results": The directory (`<results_dir>`) where the results should be stored, as a sub-directory of `<userselecteddir>` (user-defined working directory). _i.e._ "./output" in the example in the README file.  
